    ...
    return (
        <div className="mx-auto max-w-6xl space-y-6">
            <section className="ui-panel-accent p-6 md:p-8">
                <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-purple-200 bg-purple-100 px-3 py-1.5 text-sm font-bold text-purple-800 dark:border-purple-900 dark:bg-purple-950 dark:text-purple-200">
                    <Heart className="h-4 w-4" />
                    Quick review
                </div>
                <h1 className="text-3xl font-bold text-slate-950 dark:text-white md:text-5xl">Favorite Words</h1>
            ...
            {favorites.length === 0 ? (
                <div className="rounded-2xl border border-purple-100 bg-white p-8 text-center shadow-sm dark:border-slate-800 dark:bg-slate-900">
                            ...
                            <div className="flex items-start justify-between gap-4">
                                ...
                                <div className="flex shrink-0 gap-2">
                                    ...
                                    <button
                                        ...
                                        className="rounded-2xl bg-red-50 p-3 text-red-500 transition-all  focus:outline-none focus:ring-4 focus:ring-red-100 dark:bg-red-950/40"
